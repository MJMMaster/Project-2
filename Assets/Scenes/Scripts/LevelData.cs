...
public class LevelData : MonoBehaviour
{
    ...
    {
        // collect only spawn points matching this type
        ...
        // prevent infinite looping if count > available points
        ...
        for (int i = 0; i < spawnCount; i++)
        {
            ...
            SpawnPoint chosen = validPoints[index];
            ...
            // REMOVE the used spawn point to prevent duplicates
